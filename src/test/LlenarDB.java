...
public class LlenarDB {
	...
	public static void main(String[] args) {
		try {
		    ...
		    turno1.setEstado(EstadoTurno.EN_PROCESO.name());
		    ...
		    turno2.setEstado(EstadoTurno.EN_PROCESO.name());
		    turno2.setServicios(servicios2);

		    Set<Servicio> servicios3 = new HashSet<>();
		    servicios3.add(servicio4); // Masaje relajante
		    ...
		    turno3.setEstado(EstadoTurno.EN_PROCESO.name());
		    ...
		    turno4.setEstado(EstadoTurno.EN_PROCESO.name());
		    ...
		    turno5.setEstado(EstadoTurno.EN_PROCESO.name());
